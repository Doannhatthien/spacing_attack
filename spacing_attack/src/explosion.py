...
class Explosion:
    ...
    def __init__(self, x: int, y: int, lifetime_frames: int = 30):
        ...
        # ---------------------------
        # chỉnh kích thước, tuổi thọ các hạt và hiệu ứng của dụ nổ
        self.particles = []
    ...
    def draw(self, surface: pygame.Surface, explosion_img: pygame.Surface = None):
        ...
        if explosion_img:
            ...
            # chỉnh kích thước cho vụ nổ tùy chỉnh
            scaled_size = (int(70 * scale_value), int(70 * scale_value))
